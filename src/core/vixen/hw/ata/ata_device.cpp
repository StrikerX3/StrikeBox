...
void ATADevice::SetPIOTransferMode(PIOTransferType type, uint8_t mode) {
    m_pioTransferType = type;
    m_pioTransferMode = mode;
}

void ATADevice::SetDMATransferMode(DMATransferType type, uint8_t mode) {
