...
const uint32_t Reg_PTIMER_TIME_LOW    = 0x400; // [RW] Low part of the time counter        [https://envytools.readthedocs.io/en/latest/hw/bus/ptimer.html#the-time-counter]
const uint32_t Reg_PTIMER_TIME_HIGH   = 0x410; // [RW] High part of the time counter       [https://envytools.readthedocs.io/en/latest/hw/bus/ptimer.html#the-time-counter]
